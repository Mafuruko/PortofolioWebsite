  ...
  [
    {
      code: "CC-007",
      year: "2025",
      image: "Assets/Folder/evalsepoct.webp",
      alt: "September October social media evaluation thumbnail",
      title: "Evaluasi Sosial Media September-Oktober",
      category: "Paduan Suara Mahasiswa - Social Media Evaluation",
      client: "Paduan Suara Mahasiswa Kabinet Niraswara",
      role: "Kabiro Branding",
      description: "Evaluasi performa konten sosial media untuk membaca engagement, respons audiens, dan efektivitas strategi konten.",
      brief: "Melakukan evaluasi media sosial secara berkala setiap dua bulan untuk meninjau performa konten yang telah dipublikasikan serta perkembangan engagement audiens. Evaluasi dilakukan agar tim dapat memahami kondisi media sosial secara menyeluruh dan mengetahui efektivitas strategi konten yang sedang dijalankan.",
      objective: "Mengidentifikasi konten yang memiliki performa baik maupun yang masih perlu ditingkatkan dari sisi visual, pesan, dan strategi penyampaian. Evaluasi juga bertujuan memberikan insight kepada seluruh anggota mengenai perkembangan media sosial agar strategi berikutnya dapat disusun dengan lebih terarah.",
      process: [
        "Mengumpulkan dan membandingkan performa konten berdasarkan engagement dan respons audiens.",
        "Mengidentifikasi konten dengan performa terbaik serta faktor yang membuat konten tersebut berhasil.",
        "Mengevaluasi konten dengan performa lebih rendah dari sisi visual, pesan, maupun cara penyampaiannya.",
        "Menyampaikan hasil evaluasi kepada anggota sebagai bahan diskusi dan pengembangan strategi selanjutnya.",
        "Menentukan improvement dan pendekatan konten untuk periode berikutnya berdasarkan hasil evaluasi.",
      ],
      solution: "Evaluasi rutin membantu tim memahami pola konten yang efektif dan mengetahui aspek yang perlu diperbaiki. Hasil evaluasi digunakan sebagai dasar pengambilan keputusan agar strategi konten berikutnya lebih terarah, relevan, dan sesuai dengan respons audiens.",
      metrics: [
        { value: "17K", label: "Top Instagram Views" },
        { value: "1.7K", label: "Top Youtube Views" },
        { value: "2 Month", label: "Evaluation Period" },
      ],
      result: "17K Top Views",
      evidenceUrl: "https://its.id/m/NiraswaraEvalSosmedSeptemberOktober",
      evidenceImages: [],
    },
    {
      code: "CC-008",
      year: "2025",
      image: "Assets/Folder/evalnovdes.webp",
      alt: "November December social media evaluation thumbnail",
      title: "Evaluasi Sosial Media November-Desember",
      category: "Paduan Suara Mahasiswa - Social Media Evaluation",
      client: "Paduan Suara Mahasiswa Kabinet Niraswara",
      role: "Kabiro Branding",
      description: "Evaluasi konten dua bulanan untuk melihat performa engagement, konten unggulan, dan peluang improvement strategi.",
      brief: "Melakukan evaluasi media sosial secara berkala setiap dua bulan untuk meninjau performa konten yang telah dipublikasikan serta perkembangan engagement audiens. Evaluasi dilakukan agar tim dapat memahami kondisi media sosial secara menyeluruh dan mengetahui efektivitas strategi konten yang sedang dijalankan.",
      objective: "Mengidentifikasi konten yang memiliki performa baik maupun yang masih perlu ditingkatkan dari sisi visual, pesan, dan strategi penyampaian. Evaluasi juga bertujuan memberikan insight kepada seluruh anggota mengenai perkembangan media sosial agar strategi berikutnya dapat disusun dengan lebih terarah.",
      process: [
        "Mengumpulkan dan membandingkan performa konten berdasarkan engagement dan respons audiens.",
      ...
      solution: "Evaluasi rutin membantu tim membaca pola konten yang paling efektif. Insight dari performa November-Desember menjadi bahan untuk mengembangkan strategi konten yang lebih kuat pada periode berikutnya.",
      metrics: [
        { value: "180K", label: "Top Instagram Views" },
        { value: "1.2K", label: "Top Youtube Views" },
        { value: "2 Month", label: "Evaluation Period" },
      ],
      result: "180K Top Views",
      evidenceUrl: "https://its.id/m/NiraswaraEvalSosmedNovemberDesember",
      evidenceImages: [],
    },
    {
      code: "CC-009",
      year: "2026",
      image: "Assets/Folder/evaljulagus.webp",
      alt: "July August social media evaluation thumbnail",
      title: "Evaluasi Sosial Media Juli-Agustus",
      category: "Paduan Suara Mahasiswa - Social Media Evaluation",
      client: "Paduan Suara Mahasiswa Kabinet Savera",
      role: "Kabiro Branding",
      description: "Evaluasi performa sosial media Savera untuk membaca views, engagement, dan arah konten lintas platform.",
      brief: "Melakukan evaluasi media sosial secara berkala setiap dua bulan untuk meninjau performa konten yang telah dipublikasikan serta perkembangan engagement audiens. Evaluasi dilakukan agar tim dapat memahami kondisi media sosial secara menyeluruh dan mengetahui efektivitas strategi konten yang sedang dijalankan.",
      objective: "Mengidentifikasi konten yang memiliki performa baik maupun yang masih perlu ditingkatkan dari sisi visual, pesan, dan strategi penyampaian. Evaluasi juga bertujuan memberikan insight kepada seluruh anggota mengenai perkembangan media sosial agar strategi berikutnya dapat disusun dengan lebih terarah.",
      process: [
        "Mengumpulkan dan membandingkan performa konten berdasarkan engagement dan respons audiens.",
      ...
      solution: "Evaluasi sosial media digunakan sebagai dasar untuk membaca kekuatan konten tiap platform dan menyusun strategi lanjutan yang lebih relevan dengan kebiasaan audiens.",
      metrics: [
        { value: "57K", label: "Top Instagram Views" },
        { value: "2.6K", label: "Top Youtube Views" },
        { value: "7,157", label: "Top TikTok Views" },
      ],
      result: "57K Top Views",
      evidenceUrl: "https://its.id/m/SaveraEvalSosmedJuliAgustus",
      evidenceImages: [],
    },
  ],
];
